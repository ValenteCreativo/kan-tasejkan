...
import { Wallet, LogOut, ExternalLink, Copy, Check, ChevronDown } from 'lucide-react';
...
export default function ConnectWallet({ className = '', compact = false }: ConnectWalletProps) {
  const { isConnected, isLoading, formattedAddress, address, isAdmin, connect, disconnect } = useWallet();
